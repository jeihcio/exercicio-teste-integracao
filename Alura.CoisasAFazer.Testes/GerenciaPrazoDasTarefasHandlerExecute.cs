...
namespace Alura.CoisasAFazer.Testes
{
    ...
    {
        [Fact]
        public void QuantoTarefasEstiveremAtrasadasDevemMudarSeuStatus()
        {
            //arrange
            ...
            var listaTarefas = tarefas.ToArray();
            repo.IncluirTarefas(listaTarefas);
        ...
        public void QuandoInvocadoDeveChamarAtualizarTarefasNaQtddeVezesDoTotalDeTarefasAtrasadas()
        {
            ...
            mock.Setup(x => x.ObtemTarefas(It.IsAny<Func<Tarefa, bool>>()))
                .Returns(tarefas);
